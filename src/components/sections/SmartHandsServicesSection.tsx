      ...
      <div className="container mx-auto px-4 lg:px-[109px]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <RevealAnimation delay={0.2}>
            <ProblemCard 
              icon={<img src="/lovable-uploads/9ef8d897-2e08-447b-9c93-a37b7a9b896d.png" alt="Device installs" className="h-6 w-6" loading="lazy" width="24" height="24" />}
          ...
          <RevealAnimation delay={0.3}>
            <ProblemCard 
              icon={<img src="/lovable-uploads/ad064c99-a9ec-45ab-89cb-c13654380f86.png" alt="Patch cable routing" className="h-6 w-6" loading="lazy" width="24" height="24" />}
          ...
          <RevealAnimation delay={0.4}>
            <ProblemCard 
              icon={<img src="/lovable-uploads/89d97376-5c49-4a3f-b68c-b876ca74e7ec.png" alt="Hardware resets" className="h-6 w-6" />}
          ...
          <RevealAnimation delay={0.5}>
            <ProblemCard 
              icon={<img src="/lovable-uploads/1c36a68e-4f74-4dfc-afb1-f342ae1ccec1.png" alt="Unboxing" className="h-6 w-6" />}
          ...
          <RevealAnimation delay={0.6}>
            <ProblemCard 
              icon={<img src="/lovable-uploads/c71d95ff-a3c4-4a2f-a853-83124df4167e.png" alt="Vendor escorting" className="h-6 w-6" />}
          ...
          <RevealAnimation delay={0.7}>
            <ProblemCard 
              icon={<img src="/lovable-uploads/625557bd-734a-4d0d-a5be-5f43d767120e.png" alt="Port tracing" className="h-6 w-6" />}
